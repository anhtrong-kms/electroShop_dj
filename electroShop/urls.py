...
urlpatterns = [
    ...
    path('electroshop-admin/products/edit/<slug:product_slug>/', views.admin_edit_product, name='admin-edit-product'),
    path('electroshop-admin/products/delete/<slug:product_slug>/', views.delete_product, name='admin-delete-product'),
