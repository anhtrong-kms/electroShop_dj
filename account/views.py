...
def dashboard(request):
    try:
        ...
        # Nếu không có UserProfile phù hợp, tạo một mới
        user_profile = UserProfile.objects.create(user=request.user)

    # Nội dung khác của view
...
def forgotPassword(request):
    ...
    if request.method == 'POST':
        ...
        if Account.objects.filter(email=email).exists():
            ...
            messages.success(request, 'Password reset email has been sent it to your email address!')
...
def edit_profile(request):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            messages.success(request, 'Your profile edited successfuly!')
    ...
    if request.method == 'POST':
        ...
        if new_password == confirm_new_password:
            ...
            if success:
                ...
                user.save()
                # auth.logout(request) #You have to login with new password
